...
class Property(models.Model):
    ...
    property_main_image = models.ImageField(upload_to='properties/images', blank=True, null=True)
    
    # Gallery images (up to 10 images)
    gallery_images = models.ImageField(upload_to='properties/images/gallery/', blank=True, null=True)
    ...
    def price_per_sqft(self):
        return self.price / self.square_feet if self.price and self.square_feet > 0 else None
